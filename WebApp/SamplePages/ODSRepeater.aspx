...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:ObjectDataSource ID="ClientPlayListODS" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="PlayList_GetPlayListOfSSize" TypeName="ChinookSystem.BLL.PlayListController">
        <SelectParameters>
            <asp:ControlParameter ControlID="PlayListSizeArg" PropertyName="Text" DefaultValue="1000" Name="lowestplaylistsize" Type="Int32"></asp:ControlParameter>
        </SelectParameters>
